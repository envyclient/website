...
return [
     ...
     */
    'classes' => [
        'bubble' => 'hidden sm:block | bg-green-600 hover:bg-green-700 active:bg-green-700 rounded-full shadow-lg w-14 h-14 text-white p-4',
        ...
        'button' => 'inline-flex place-center px-4 py-3 h-10 border-0 bg-green-500 hover:bg-green-600 active:bg-green-600 overflow-hidden rounded-sm text-white leading-none no-underline',
    ],
];
