                ...
                <div class="flex flex-col h-0 flex-1 bg-gray-800">
                    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-5 flex-1 px-2 bg-gray-800 space-y-1">
                            ...
                            <a href="{{ route('home.discord') }}"
                               class="{{ Route::is('home.discord') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                <svg
                                    class="{{ Route::is('home.profile') ? 'text-gray-300' : 'text-gray-400 group-hover:text-gray-300' }} mr-3 h-6 w-6"
                                    xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
