...
@section('content')
    ...
    @else
        ...
        @if($user->subscription !== null && $user->subscription->status === \App\Enums\SubscriptionStatus::PENDING->value)
        ...
        @elseif($user->subscription !== null && $user->subscription->status !== \App\Enums\SubscriptionStatus::CANCELED->value)
